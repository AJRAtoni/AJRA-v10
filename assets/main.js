...
(function() {
				...
				sections = {
					'about': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'UA-13200300-5', { 'page_path': '/#about' });
								},
							],
						},
					},
					'portfolio': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'UA-13200300-5', { 'page_path': '/#portfolio' });
								},
							],
						},
					},
					'home': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'UA-13200300-5', { 'page_path': '/' });
								},
							],
						},
					},
	...
	// Initialize "On Visible" animations.
		onvisible.add('.image.style1', { style: 'fade-in', speed: 2000, intensity: 5, delay: 0, replay: false });
		onvisible.add('h1.style1, h2.style1, h3.style1, p.style1', { style: 'fade-up', speed: 1000, intensity: 4, delay: 250, replay: false });
		onvisible.add('h1.style2, h2.style2, h3.style2, p.style2', { style: 'fade-up', speed: 1000, intensity: 4, delay: 375, replay: false });
		onvisible.add('#icons01', { style: 'fade-up', speed: 1000, intensity: 6, delay: 500, stagger: 250, staggerSelector: ':scope > li', replay: false });
		onvisible.add('#buttons02', { style: 'fade-right', speed: 1000, intensity: 5, delay: 750, stagger: 250, staggerSelector: ':scope > li', replay: false });
		onvisible.add('#icons04', { style: 'fade-down', speed: 1000, intensity: 6, delay: 500, stagger: 250, staggerSelector: ':scope > li', replay: false });
		onvisible.add('#text06', { style: 'fade-up', speed: 1000, intensity: 4, delay: 375, replay: false });
		onvisible.add('#buttons03', { style: 'fade-up', speed: 1000, intensity: 5, delay: 500, replay: false });
		onvisible.add('#buttons01', { style: 'fade-up', speed: 1000, intensity: 5, delay: 500, replay: false });
		onvisible.add('#icons02', { style: 'fade-down', speed: 1000, intensity: 6, delay: 500, stagger: 250, staggerSelector: ':scope > li', replay: false });
